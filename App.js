...
function App() {
  ...
  const [inputThreshold, setinputThreshold] = useState(0); // Initial threshold value
  // Add an event handler to update the user-set threshold
  function setConcLim0(params) {
    setinputThreshold(0.0);
  }
  function setConcLim07(params) {
    setinputThreshold(0.7);
  }
  ...
  const colorRange = ["rgb(240, 240, 240)", "rgb(26, 0, 153)"];
